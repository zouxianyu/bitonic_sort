...
**(The report would ideally embed the `performance_comparison_loglog.png` image here.)**

**Figure 1: Performance Comparison of Bitonic Sort Implementations (Log-Log Scale)**
*(Description of `doc/figures/performance_comparison_loglog.png`)*
...
**(The report would ideally embed the `std_thread_scalability.png` image here.)**

**Figure 2: Scalability of `StdThreadBitonicSorter` (CPU Time vs. Threads for N=65536)**
*(Description of `doc/figures/std_thread_scalability.png`)*
...
echo "doc/report.md created successfully."
echo "Please review the generated report."
